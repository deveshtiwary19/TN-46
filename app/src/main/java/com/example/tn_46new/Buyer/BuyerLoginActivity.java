...
public class BuyerLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window= BuyerLoginActivity.this.getWindow();
        window.setStatusBarColor(ContextCompat.getColor(BuyerLoginActivity.this, R.color.mainyellow));
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final BottomSheetDialog bottomSheetDialog=new BottomSheetDialog(BuyerLoginActivity.this);
                View dialog= LayoutInflater.from(BuyerLoginActivity.this).inflate(R.layout.layout_forget_password,null);
                                ...
                                FirebaseDatabase.getInstance().getReference().child("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                        .addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                ...
                                                {
                                                    makeToast("Incorrect Pannel! Switch to seller pannel",1);
                                                    progressDialog.dismiss();
                                                    email.setText("");
                                                    password.setText("");
                                                    confirmPass.setText("");
    ...
    private void init() {
        tile=findViewById(R.id.title_buyerlogin);
        email=findViewById(R.id.email_buyerlogin);
        password=findViewById(R.id.password_buyerlogin);
        confirmPass=findViewById(R.id.confirmPassword_buyerlogin);
        forgotPassword=findViewById(R.id.forgetPassword_buyerlogin);
        loginBtn=findViewById(R.id.loginBtn_buyerlogin);
        login_register_link=findViewById(R.id.register_loginLink_buyerlogin);
    }

    public void makeToast(String textToShow, int lenght)
    {
        LayoutInflater inflater = BuyerLoginActivity.this.getLayoutInflater();
